...
@if ($kunjungan->file_surat)
    <a href="{{ str_starts_with($kunjungan->file_surat, 'http') ? $kunjungan->file_surat : asset('storage/surat/' . $kunjungan->file_surat) }}"
       target="_blank"
...
@else
    <button disabled class="w-full flex items-center justify-center gap-2 py-3 bg-gray-300 text-gray-500 text-xs font-bold rounded-xl cursor-not-allowed">
        Belum Ada Berkas
    </button>
@endif
                </div>
